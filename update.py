...
CONFIG_FILE_URL = env.get('https://gist.githubusercontent.com/CineHub4U1/3d80b4d9e2865183a69ae1a2cf662952/config.env')
try:
...
UPSTREAM_REPO = env.get('UPSTREAM_REPO', "https://github.com/CineHub4U1/Tele-LeechX-1")
